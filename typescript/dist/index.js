...
export class Undercore {
    ...
    constructor(config) {
        ...
        this.works = {
            list: (params) => this._request("/v1/works", params),
            get: (id) => this._request(`/v1/works/${id}`),
        };
        this.writers = {
            list: (params) => this._request("/v1/writers", params),
            get: (id) => this._request(`/v1/writers/${id}`),
        };
    }
    /**
